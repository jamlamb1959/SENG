...
#define PROG "firmware/jal/esp32dev/UPLINK_MESH/firmware"
...
static void _loadMac(
    ...
    {
    WiFi.macAddress( rawMac_g );
    sprintf( mac_g, "%02X:%02X:%02X:%02X:%02X:%02X",
            rawMac_g[ 0 ], rawMac_g[ 1 ], rawMac_g[ 2 ], 
            rawMac_g[ 3 ], rawMac_g[ 4 ], rawMac_g[ 5 ] );
    }
...
/*
    chMap_g[ std::string( "beb5483e-36e1-4688-b7f5-ea07361b26a8" ) ] = string_l;
    chMap_g[ std::string( "beb5483e-36e1-4688-b7f5-ea07361b26aa" ) ] = string_l;
    chMap_g[ std::string( "beb5483e-36e1-4688-b7f5-ea07361b26ab" ) ] = string_l;
    chMap_g[ std::string( "beb5483e-36e1-4688-b7f5-ea07361b26ac" ) ] = string_l;
    chMap_g[ std::string( "beb5483e-36e1-4688-b7f5-ea07361b26ad" ) ] = string_l;

    chMap_g[ std::string( "494e5445-4c4c-495f-524f-434b535f2011" ) ] = hex_l;
    chMap_g[ std::string( "494e5445-4c4c-495f-524f-434b535f2012" ) ] = hex_l;
    chMap_g[ std::string( "494e5445-4c4c-495f-524f-434b535f2013" ) ] = hex_l;
    chMap_g[ std::string( "00010203-0405-0607-0809-0a0b0c0d2b12" ) ] = hex_l;
*/
